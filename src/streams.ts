...
export class HiMDBlockStream {
    ...
    constructor(protected himd: HiMD, protected atdata: HiMDFile, public fragments: HiMDFragment[], public framesPerBlock: number) {
...
export class HiMDNonMP3Stream {
    ...
    constructor(public blockStream: HiMDBlockStream, public frameSize: number, protected masterKey: Uint8Array) {}
...
export class HiMDMP3Stream {
    constructor(public blockStream: HiMDBlockStream, public frameSize: number, private key: Uint8Array) {}
...
export class HiMDWriteStream {
    ...
    public async close() {
        if (!this.doNotCloseATData) await this.atdata.close();
